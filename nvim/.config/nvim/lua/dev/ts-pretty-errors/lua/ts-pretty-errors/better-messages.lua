...
M.translate = function(message, error_num)
  if message == nil or message == "" or error_num == nil or error_num == "" then
    return message
  end
  ...
  local better_error = better_error_message(message, parsed["original"], parsed["better"])
